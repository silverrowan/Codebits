...
JavaScript will attempt to convert strings to numbers in numeric operations **WITH THE EXCEPTION of** (Binary) ADDITION (as used for concatenation as well)
- `+` addition (& concatenation & convert to num, by context)
- `-` subtraction
...
*******
Related:: [[Modify & Assign Operators]], [[Logical Operators]], [[Logical Assignment Operators]], [[Comparison Operators]], [[Bitwise Operators]]