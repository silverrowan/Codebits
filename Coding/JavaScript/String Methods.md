...
- if the separator is "", the returned array will be single characters.
    - let splitTest = codeTest.split("") //splits to single char
        - // splitTest = ["H", "e", "l", "l", "o", ",", " ", ... ]
### More Methods
- [[Comparison Operators|Comparisons]] using > & < & >= & <= are case sensitive
...
- exhaustive list of methods found here: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String