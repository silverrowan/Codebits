...
- \*\* the result here is an ***OFFICIALLY RECOGNIZED & MAINTAINED ERROR*** in typeof.
    - [[Null Data Type|null]] is NOT an object. it is its own type.
    - this error is kept for compatibility with older code.
- \*\*\* the response is "function" because alert is a [[Function Basics|function]] but this is NOT an actual [[Data Types|data type]] in JavaScript. *Functions are a special type of [[Object & Symbol Data Types|object]].*